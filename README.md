...
| ---------------- | ---------------: | ----------------------------------- |
| WordPress        | 4 (+1 duplicate) | [wordpress/](./wordpress/README.md) |
...
| CVE-2026-16297        | [Clearfy < 2.4.3 - Admin+ PHP Object Injection via Settings Import](./wordpress/plugins/clearfy/CVE-2026-16297/README.md)                                                 | WordPress        | Clearfy Cache – WordPress optimization plugin, Minify HTML, CSS & JS, Defer | Insecure Deserialization       | Medium (4.1)        |
| CVE-2026-14331        | [Subscribe2 < 10.46 - Reflected XSS via email Parameter](./wordpress/plugins/subscribe2/CVE-2026-14331/README.md)                                                         | WordPress        | Subscribe2 – Form, Email Subscribers & Newsletters                          | Reflected Cross-Site Scripting | Medium (4.7)        |
| Dup of CVE-2026-16296 | [Clearfy < 2.4.3 - Open Redirect via Cyrlitera 404 Handler](./wordpress/plugins/clearfy/open-redirect-via-cyrlitera-component/README.md)                                  | WordPress        | Clearfy Cache – WordPress optimization plugin, Minify HTML, CSS & JS, Defer | Open Redirect                  | Medium (4.7)        |
